...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    if (!kvkkAccepted) {
      Alert.alert(t('auth.error'), t('auth.kvkkRequired'));
      return;
    }
    ...
    try {
      ...
      Alert.alert(t('auth.registerError'), error.response?.data?.detail || t('auth.registerFailed'));
    } finally {
      setIsLoading(false);
    }
  };
      ...
      >
        ...
        >
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputContainer}>
              <Ionicons name="call-outline" size={22} color="#E91E8C" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
            ...
            <View style={styles.loginContainer}>
              ...
              <Link href="/(auth)/login" asChild>
                <TouchableOpacity>
                  <Text style={styles.loginLink}>{t('auth.hasAccountAction')}</Text>
                </TouchableOpacity>
              </Link>
            </View>
          </View>
