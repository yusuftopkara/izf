...
export default function EventsScreen() {
  ...
  const formatDate = (dateStr: string) => {
    try {
      return format(new Date(dateStr), 'd MMMM yyyy, HH:mm', { locale: locale === 'tr' ? tr : enUS });
    } catch {
      return dateStr;
    }
  };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.cityFilter}>
          ...
          >
            <Text style={[styles.cityChipText, !selectedCity && styles.cityChipTextActive]}>{t('events.all')}</Text>
          </TouchableOpacity>
          {cities.map((city) => (
            <TouchableOpacity
              key={city}
                ...
                <View style={styles.eventFooter}>
                  ...
                  <View style={styles.capacityBadge}>
                    ...
                    <Text style={styles.capacityText}>
                      {event.capacity - event.tickets_sold} {t('events.remaining')}
                    </Text>
                  </View>
                </View>
              </LinearGradient>
