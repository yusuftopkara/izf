    ...
    return (
      <div className="min-h-screen bg-[#0d0d1a] pt-20 flex items-center justify-center">
        <div className="text-center">
          <p className="text-white/60 mb-4">Giriş yapmanız gerekiyor</p>
      ...
      <div className="mx-auto max-w-2xl px-4 py-8">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-white/50">Hesap bilgilerinizi yönetin</p>
          </div>
        </div>
        ...
        <div className="mb-8 rounded-3xl bg-[#1a1a2e] border border-white/10 p-6">
          <h2 className="mb-4 text-lg font-bold text-white">Profil Bilgileri</h2>

          {loading ? (
            <div className="py-8 text-center text-white/40">Yükleniyor...</div>
          ) : (
            <form onSubmit={handleSaveProfile} className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-white/30">E-posta değiştirilemez</p>
              </div>

              {/* Phone */}
              <div>
                <label className="mb-1 block text-xs font-semibold text-white/60">Telefon Numarası</label>
                <div className="relative">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              {/* City */}
              <div>
                <label className="mb-1 block text-xs font-semibold text-white/60">Şehir</label>
                <div className="relative">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              {/* Bio */}
              <div>
                <label className="mb-1 block text-xs font-semibold text-white/60">Hakkımda</label>
                <textarea
                  value={form.bio}
        ...
        {/* Password Change */}
        <div className="mb-8 rounded-3xl bg-[#1a1a2e] border border-white/10 p-6">
          <h2 className="mb-4 text-lg font-bold text-white">Şifre Değiştir</h2>

          <form onSubmit={handlePasswordChange} className="space-y-4">
            <div>
              <label className="mb-1 block text-xs font-semibold text-white/60">Mevcut Şifre</label>
              <input
                type="password"
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold text-white/60">Yeni Şifre</label>
              <input
                type="password"
                value={newPassword}
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold text-white/60">Yeni Şifre (Tekrar)</label>
              <input
                type="password"
        ...
        <div className="rounded-3xl bg-red-500/10 border border-red-500/20 p-6">
          <h2 className="mb-4 text-lg font-bold text-red-400">Oturum</h2>
          <p className="mb-4 text-sm text-white/50">Hesabınızdan çıkış yapın</p>
          <button
